...
export const getCharactersData = async (queryParams: QueryParams) => {
    ...
    if (tag_name) {
        let query = supabase.from("characters")
            ...
            .eq('character_tags.tags.join_name', tag_name);
        ...
        //    const total = count ? Math.ceil(count / rowsPerPage) : 0;
        const total = count;

        // console.log(total,"total")
        // console.log(data,"data")

        // console.log(data?.map(item => item.id), total, "data, count");
        ...
        // console.log("aaaaaaaaaaaaaa",flatFilterData,"aaaaaaaaaaaaaaaaa");
        // console.log("bbbbbbbb",data,"bbbbbbbbbbbbb")
